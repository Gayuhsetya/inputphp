...
--
-- Table structure for table `daftar_tabel`
--

CREATE TABLE `daftar_tabel` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `daftar_tabel`
--
...
--
-- Indexes for table `daftar_tabel`
--
...
--
-- AUTO_INCREMENT for table `daftar_tabel`
--
ALTER TABLE `tabel_kelas`
